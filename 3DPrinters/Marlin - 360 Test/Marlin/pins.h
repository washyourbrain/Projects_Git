...
// TODO_MY похоже эта плата, но надо узнать подробнее -> 1.4
  ...
  #else
    #define FAN_PIN            4 // IO pin. Buffer needed // TODO_MY ????
  #endif
  ...
  #define PS_ON_PIN          -1 //akyaky Original value 12
  ...
  #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    ...
    #define BEEPER 33
      ...
      #define LCD_PINS_D7 29
        ...
        #define BEEPER 37
        #define KILL_PIN 41 //AKYAKY
        #define BTN_EN1 33 //  AKYAKY SWAP ENCODER
        #define BTN_EN2 31 //  33 to 31
        #define BTN_ENC 35
