...
const char utf_recode[] PROGMEM=
       { 0x41,0x42,0x42,0x00,0x01,0x45,0x02,0x33,0x03,0x03,0x4b,0x04,0x4d,0x48,0x4f,
         0x05,0x50,0x43,0x54,0x59,0xb7,0x58,0xe1,0x34,0x57,0x57,0x60,0x06,0x62,0xaf,0xb0,0x07,
         0x41,0x42,0x42,0x00,0x01,0x45,0x02,0x33,0x03,0x03,0x4b,0x04,0x4d,0x48,0x4f,
         0x05,0x50,0x43,0x54,0x59,0xb7,0x58,0xe1,0x34,0x57,0x57,0x60,0x06,0x62,0xaf,0xb0,0x07,
        };
...
#endif
{
  ...
  if ((value>=0x80)&& (value !=0xdf) && (value !=0xdb)&& (value !=0xff)) { // UTF-8 handling exept Nozzle & Bed symbols
    if (value >= 0xc0) {
